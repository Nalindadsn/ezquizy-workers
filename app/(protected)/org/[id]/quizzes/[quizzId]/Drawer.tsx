...
import MathSigma from "@/components/math/sigma";
      ...
      <div className="flex w-full justify-between mb-3">
        ...
        {open && (
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-h-screen overflow-y-scroll max-w-[800px] ">
              <DialogHeader>
                          ...
                          <div className="p-3">
                            {i?.questions.map((x: any, index: number) => {
                              return (
                                <div
                                  key={x.id}
                                  className="border-t  mb-1 p-3 bg-indigo-500 border-gray-800"
                                >
